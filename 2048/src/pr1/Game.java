...
public class Game {
	...
	public Game(int sizeBoard,int numCells, Random random){
		...
		while(currentCells < numCells){
			...
			if(board.isBoardEmpty(randomRow,randomCol)){
				...
				board.setCell(new Position(randomRow, randomCol), 2);					currentCells++;
			}
		}*/
		}

	/**
	 * Looks for the cell with the highest value on the game.
	 * 
	 * @return the highest value on the game.
	 */
	...
	/**
	 * Sets the value introduced as paramether in the cell os the position which was also introduced.
	 * 
	 * @param value value to set.
	 * @param pos position of the cell which value will change.
	 */
	...
	/**
	 * Getter method of the board of the game.
	 * 
	 * @return the board in which the game is taking place.
	 */
	...
	/**
	 * Adds to the string which contain the board the current score and the highest value.
	 * 
	 * @return the new sting containing the board in tis current situation and the score and highest value.
	 */
	...
	/**
	 * Sets both score and highestValueCell back to 0 and resets the board, finally places the inital cells.
	 */
